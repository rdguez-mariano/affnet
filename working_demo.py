...
#Image loading
try:
    input_img_fname1 = 'examples/hesaffnet/img/kpi1.png'#sys.argv[1]
    input_img_fname2 = 'examples/hesaffnet/img/kpi2.png'#sys.argv[2]
...
print "number of matches: ", mask.shape
